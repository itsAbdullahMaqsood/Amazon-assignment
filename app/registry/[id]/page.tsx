...
const Page = async ({ params }: any) => {
    ...
    return (
        <>
            <Header title={registry.name} />

            <main className="bg-[#eaeded] min-h-[60vh]">
                ...
                <div className="max-w-[1200px] mx-auto px-4 py-8">
                    ...
                    {items.length ? (
                            ...
                            {items.map((item: any) => (
                                ...
                                >
                                    ...
                                    <Link
                                        ...
                                        className="mt-3 text-[#0F5FA6] hover:underline line-clamp-2"
                                    >
                                        {item.name}
                                    </Link>
                        ...
                        <div className="mt-6 bg-white border border-slate-300 rounded-lg p-8">
                            ...
                            <Link
                                href="/registry/find"
                                className="inline-block mt-4 text-[#007185] hover:underline"
                            >
