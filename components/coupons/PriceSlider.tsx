...
const thumb =
    ...
    "[&::-webkit-slider-thumb]:bg-accent-ink [&::-webkit-slider-thumb]:border-2 " +
    ...
    "[&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-accent-ink [&::-moz-range-thumb]:border-2 " +
    ...
    return (
        <div>
            ...
            <div className="relative h-5 mt-3">
                ...
                <span
                    className="absolute top-1/2 -translate-y-1/2 h-1 rounded bg-accent-ink"
