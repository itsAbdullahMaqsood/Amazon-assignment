    ...
    return (
        <>
            ...
            <main className="bg-white min-h-screen">
                ...
                <section className="bg-success-soft py-10">
                ...
                <div className="max-w-[1100px] mx-auto px-6 py-10">
                    ...
                    {medications.length === 0 ? (
                        <div className="border border-slate-200 rounded-lg p-8 mt-6">
                            ...
                            <Link href="/pharmacy" className="inline-block mt-4 text-success hover:underline">
                                Back to Markaz Pharmacy ›
                            </Link>
                        </div>
                    ) : (
                            ...
                            {medications.map((medication: any) => (
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs text-slate-500 mt-2">Price with Plus</p>
                                        <Price value={medication.primePrice} size="sm" />

                                        {medication.rxPassEligible && (
                                            <p className="mt-2 text-xs font-semibold text-success">
                                                Included with Rx Saver
                                            </p>
                                        )}
                                    </div>
                                </li>
