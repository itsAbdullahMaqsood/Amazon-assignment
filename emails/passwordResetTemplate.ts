          ...
          <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
            ...
            <tr>
              <td style="background:#ffffff;padding:32px 24px;">
                <h1 style="margin:0 0 16px;font-size:22px;color:#111111;">Password reset</h1>
                ...
                <p style="margin:24px 0 0;font-size:13px;color:#b12704;line-height:1.5;">
                  This link expires in 6 hours.
                </p>
                <p style="margin:12px 0 0;font-size:12px;color:#767676;line-height:1.5;">
            ...
            <tr>
              <td style="padding:16px 24px;">
                <p style="margin:0;font-size:11px;color:#767676;line-height:1.5;">
                  If you did not ask for a password reset you can ignore this message.
                </p>
              </td>
            </tr>
          </table>
