...
export const PillPackArt = () => (
    <div className="relative w-full h-[360px]">
        <div className="absolute right-10 top-6 w-64 h-64 rounded-full bg-success" />
        ...
        <div className="absolute left-2 top-16 w-64 rotate-[-8deg] bg-white rounded-lg shadow-xl p-4">
            ...
            <p className="mt-4 text-xs text-slate-500">markaz pharmacy</p>
        </div>

        <div className="absolute right-16 top-20 w-40 rotate-[8deg]">
            <div className="h-6 rounded-t-xl bg-success" />
            <div className="bg-accent-deep rounded-b-lg p-3 pt-4">
                <div className="bg-white rounded p-2">
                    <p className="text-[10px] text-slate-500">markaz pharmacy</p>
...
export const PrimeSavingsArt = () => (
    <div className="bg-accent-soft h-[260px] flex items-center justify-center p-6">
        <div className="bg-white rounded-lg shadow p-4 w-64">
            <p className="font-bold">Price with Plus</p>
            <p className="mt-1">
                <span className="text-danger text-xl font-bold mr-2">-80%</span>
                <span className="text-xl font-bold">$10</span>
                <span className="text-sm align-top">00</span>
            </p>
            <p className="text-xs text-slate-500 mt-1">$40.00 Plus savings</p>
        </div>
    </div>
);
...
export const RxPassArt = () => (
    <div className="bg-accent-soft h-[260px] flex items-center justify-center p-6">
        <div className="w-32 h-32 rounded-full bg-accent-ink text-white flex flex-col items-center justify-center">
    ...
    <div className="bg-accent-soft h-[260px] flex items-center justify-center p-6">
        <div className="bg-white rounded-lg shadow p-4 w-64">
            ...
            <p className="text-xs text-slate-500 mt-1 flex items-center gap-1">
                <span className="bg-accent-deep text-white text-[10px] px-1 rounded">Coupon</span>
...
export const InsuranceCardArt = () => (
    <div className="bg-success rounded-2xl p-10 flex items-center justify-center">
        <div className="w-full max-w-sm rounded-xl overflow-hidden shadow-xl rotate-[-6deg]">
            <div className="bg-success text-white px-4 py-3 text-sm font-semibold">
...
export const DeliveryArt = () => (
    <div className="relative h-[280px] flex items-center justify-center">
        <div className="w-64 h-40 bg-warning-soft rounded-md shadow-lg" />
