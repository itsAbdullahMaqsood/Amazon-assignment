...
// white card with the heading, body copy and one button, then the fallback link.
export const emailLayout = ({ email, heading, body, url, button, footnote }: any) => `
<!DOCTYPE html>
<html>
